...
signals
sockets
= usual IPC for processes
threads advantage share memory so can use locks and memory allocations, lock count??
to verify
fifo buffer shared thread
...
The instructions for a \hyperref{https://nagios-plugins.org/doc/guidelines.html#DEVREQUIREMENTS}{Nagions plugin} are used to create the proper plugin output.
