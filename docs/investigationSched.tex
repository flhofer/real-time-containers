...
While before a task uses the resource slot between average and peak only with a low probability, reducing the WCET increases resource utilization at a probability cost.
