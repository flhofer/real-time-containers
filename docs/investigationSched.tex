...
In this kernel configurations we disabled some debug features and increased the scheduler base tick frequency.
...
The orchestrator reports scan times and run-time budgets. %TODO: add more details
