...
Lately the trend to imoment the single sorfteare modules into containers, isolated threads tunning in paralel on shared softeare. this has the advantage of a abstracting the software modle from its host, making maintangenca and redundancy quite easy to achieve % rerfenrec to paper redundancy migration
