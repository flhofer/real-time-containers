...
The orchestrator's primary goal is to allocate container resources in order to mantain determinism at best.
To achieve this, containers and their running processes have to be confined in their execution context. 
We have seen in Section \ref{sec:mgmttest} a variety valid techniques to obtain such an isolation. 
In section \ref{sec:testimp} these techniques have then be used to explore the appplication of those to check, maintain and monitor running containers.
