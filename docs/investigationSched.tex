...
%!manage
%assigns resources to containers. Algorithm of allocation and container configuration resides here
...
Table \ref{schedsim} shows results of the second test batch for different utilization rates.
