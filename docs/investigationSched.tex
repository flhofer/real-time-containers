...
%TODO: what is the decision based on?
...
In such case the tasks may exceed the configured worst case run-time $w_{i_c}$, but the probability is low and contemporaneity factor even lower. %TODO: w_ic vs w_i explanation or graph
...
%To consider also latest kernel updates and patches, we reconfigured both systems with the newest kernel.
%TODO:
...
%The performance of the kernel is increased as we change debugging and synchronization settings.
...
The first is main the progam start , defines enviroment parameters for run-time of the other tasks, the interval, and other optional run parameters. 
...
%TODO: extend and add op details: loop execution ecc.
