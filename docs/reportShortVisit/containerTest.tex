...
\footnote{Update: In a discussion thread I found that in the source code of cyclictest for Xenomai, the \texttt{sched\_setsched} invocation to update the priority of a thread has to be replaced with  \texttt{pthread\_setschedparam} to properly set it for RT-tasks. The paper test have been updated accordingly}
