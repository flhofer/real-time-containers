...
// From gl/configmake.h
#define LOCALEDIR "/usr/local/nagios/share/locale"
// from NP-VERSION-FILE
#define NP_VERSION "2.2.1.git"

const char *progname = "check_rtapp";
const char *copyright = "2018-2019";
const char *email = "florian.hofer@stud-inf.unibz.it";
...
*/
    ...
    if (strstr (chld_out.line[i], ";; ANSWER SECTION:")) {
      ...
      for(; i < chld_        /* get the host address */out.lines; i++) {
